...
namespace KuCoin.NET.Helpers
{
    ...
    /// <summary>
    /// A version of <see cref="RedBlackTree{T}"/> with an additional cross-reference for keys.
    /// </summary>
    /// <typeparam name="TKey">The type of key.</typeparam>
    /// <typeparam name="TValue">The type of value.</typeparam>
    public abstract class KeyedRedBlackTree<TKey, TValue> : RedBlackTree<TValue> where TKey : IComparable<TKey>
    {
        List<TValue> items;
    ...
    /// </remarks>
    public class RedBlackTree<T> : ComparingBase<T>, ICollection<T>
    {
        #region Protected Fields
        ...
        public RedBlackTree(IComparer<T> comparer, float threshold = 1.2f, RebalanceStrategy globStrategy = RebalanceStrategy.Cadance4, RebalanceStrategy locStrategy = RebalanceStrategy.Cadence16) : base(comparer)
        {
